...
% SPDX-FileCopyrightText: 2018-2023 Multidisciplinary Digital Publishing Institute
% SPDX-License-Identifier: CC-BY-SA-3.0
% SPDX-FileContributor: Carsten Lemmen

% You need to save the "comses.cls" and "mdpi.bst" files into the same folder as this template file.

%=================================================================
\documentclass[$journal$,$type$,$status$,oneauthor,pdftex,10pt,a4paper]{comses}

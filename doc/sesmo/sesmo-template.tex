...
% You need to save the "sesmo.cls" and "sesmo.bst" files into the same folder as this template file.

%=================================================================
\documentclass[$journal$,$type$,$status$,oneauthor,pdftex,10pt,a4paper]{sesmo}
